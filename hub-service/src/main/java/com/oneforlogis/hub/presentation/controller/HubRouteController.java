...
public class HubRouteController {
    ...
    @Operation(summary = "신규 허브 경로 생성", description = "새로운 물류 허브를 등록합니다. 'MASTER' 권한이 필요합니다.")
    @PreAuthorize("hasRole('MASTER')")
    @PostMapping
    public ApiResponse<HubRouteResponse> createHub(@RequestBody HubRouteCreateRequest request) {
