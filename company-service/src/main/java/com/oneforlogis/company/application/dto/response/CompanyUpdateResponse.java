...
@Schema(description = "업체 수정 응답 DTO")
public record CompanyUpdateResponse(

        @Schema(description = "수정 시행한 업체 ID", example = "42b1c3b0-0b1a-4b1a-9b1a-0b1a4b1a0b1a")
        UUID id,

        @Schema(description = "수정 된 업체명", example = "스파르타 산업")
        String name,

        @Schema(description = "수정 된 업체 타입", example = "SUPPLIER, RECEIVER")
        CompanyType type,

        @Schema(description = "소속 허브 ID", example = "31b1c3b0-0b1a-4b1a-9b1a-0b1a4b1a0b1a")
        UUID hubId,

        @Schema(description = "수정 된 업체 주소", example = "서울특별시 강남구 테헤란로 123")
        String address,

        @Schema(description = "수정자", example = "userId")
        String updatedBy,

        @Schema(description = "수정일시", example = "2025-11-06 T12:00:00")
